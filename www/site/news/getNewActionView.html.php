...
<?php if ($g_user->haveRight('news_edit')){ ?>
		<tr>
			<td>
				...
				<script language="javascript" type="text/javascript">
					$("#news_date").datepicker($.extend({}, $.datepicker.regional["fr"], {     firstDay: 1,     changeFirstDay: false,    dateFormat: "dd/mm/yy",     showOn: "button",     buttonImage: "<?php echo $this->createUriFromBase('img/#SKIN#/calendar.gif'); ?>",     buttonImageOnly: true }));
				</script>
			</td>
		</tr>
		<tr>
