 ...
 *$thumb = new Image('sample.jpg'); 
 *$thumb->name('sample');
 *$thumb->name($thumb->name().'_200');
 *$thumb->width(200);
 *$thumb->save();
 *
 ...
 *$thumb = new Image('sample.jpg');
 *$thumb->name('sample');
 *$thumb->name($thumb->name().'_50percent'); 
 *$thumb->resize(50);
 *$thumb->save();
 *
 ...
 *$thumb = new Image('sample.jpg'); 
 *$thumb->name('sample'); 
 *$thumb->name($thumb->name().'_crop');
 *$thumb->crop(($thumb->image_width/2),($thumb->image_height/2));	
 *$thumb->width(100);
 *$thumb->height(100);
 *$thumb->save();
*/
